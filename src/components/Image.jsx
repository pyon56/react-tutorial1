import pic1 from "/images/favorite-1.jpg";
export default function Image() {
    return (
        <aside>
            <h2>Favourite photos</h2>
            <a href="pic1"><img src="./images/favorite-1_th.jpg" alt="Small black bird, black claws, long black slender beak, links to larger version of the image" /></a>
